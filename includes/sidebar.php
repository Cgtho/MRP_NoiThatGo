...
<aside class="w-64 bg-[#0f172a] shrink-0 flex flex-col border-r border-slate-700 overflow-y-auto scrollbar-custom">
    ...
    <nav class="flex-1 px-3 py-4 space-y-6">
        ...
        <div>
            ...
            <a href="dashboard.php" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-blue-600 text-white font-medium">
        ...
        <div>
            ...
            <ul class="space-y-1">
                <li>
                    <a href="bom_formula.php" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
                        <i class="fa-solid fa-layer-group text-blue-400 w-5 text-center"></i> Định mức sản phẩm (BOM)
                    </a>
                </li>
                <li>
                    <a href="production_orders.php" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
                        <i class="fa-regular fa-clipboard text-indigo-400 w-5 text-center"></i> Lệnh sản xuất (Yêu cầu)
                    </a>
                </li>
                <li>
                    <a href="import_materials.php" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
                        <i class="fa-solid fa-box-open text-emerald-400 w-5 text-center"></i> Nhập kho NVL (Phiếu nhập)
                    </a>
                </li>
                <li>
                    <a href="export_materials.php" class="flex justify-between items-center px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
                ...
                <li>
                    <a href="export_products.php" class="flex justify-between items-center px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
                        <div class="flex items-center gap-3">
                ...
                <li>
                    <a href="reports.php" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
        ...
        <div>
            ...
            <ul class="space-y-1">
                <li>
                    <a href="inventory.php" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition">
